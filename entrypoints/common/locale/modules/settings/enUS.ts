export default {
  ...
  'settings.syncType.autoPullMerge': 'Auto Pull (Merge): Pull remote data and merge it into local data.',
  ...
  'settings.syncType.manualPullMerge': 'Manual Pull (Merge): Pull remote data and merge it into local data.',
