export default {
  ...
  'settings.openAdminTabAfterBrowserLaunch': 'Open the NiceTab-Admin-Page after launching the browser?',
  ...
  'settings.autoPinAdminTab': 'Pin the NiceTab-Admin-Page?',
  ...
  'settings.openAdminTabAfterSendTabs': 'Open the NiceTab-Admin-Page when sending tabs?',
