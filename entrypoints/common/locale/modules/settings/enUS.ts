...
const enUS: Record<LocaleKey, string> = {
  ...
  'settings.block.newtab': 'Newtab Page',
  ...
  'settings.newTabDisplay': 'Newtab Display:',
  'settings.newTabDisplay.tooltip': `Customize the newtab page. Selecting "Default" will restore the browser's native newtab page.`,
  'settings.newTabDisplay.homePage': 'NiceTab List Home Page (NiceTab-controlled)',
  'settings.newTabDisplay.niceNewtab': 'NiceTab Newtab Page (NiceTab-controlled)',
  'settings.newTabDisplay.default': 'Default (restore the native newtab page)',
