...
const enUS: Record<LocaleKey, string> = {
  ...
  'settings.newTabDisplay.tooltip': `Customize the newtab page. Set to "Default" will revert to the browser's native newtab page.`,
  'settings.newTabDisplay.homePage': 'NiceTab List Page (NiceTab-controlled)',
  'settings.newTabDisplay.niceNewtab': 'NiceTab Newtab Page (NiceTab-controlled)',
  'settings.newTabDisplay.default': 'Default (revert to native newtab page)',
