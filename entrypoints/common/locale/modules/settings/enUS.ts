...
const enUS: Record<LocaleKey, string> = {
  ...
  'settings.openAdminTabAfterWindowCreated': 'Open NiceTab Admin Page when a window is created?',
  ...
  'settings.openTabModifierKey.tooltip': 'Foreground opening takes precedence over background opening. When the modifier keys for both are the same, the foreground opening action will be triggered.',
