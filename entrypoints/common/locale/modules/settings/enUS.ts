...
const enUS: Record<LocaleKey, string> = {
  ...
  'settings.newTabDisplay.home-list': 'List',
  'settings.newTabDisplay.starred-search': 'Search Groups + Starred Groups',
  'settings.newTabDisplay.disabled': 'Disabled (release control)',
