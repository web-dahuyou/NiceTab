const zhCN = {
  ...
  'settings.openAdminTabAfterWindowCreated': '新开浏览器窗口时是否自动打开NiceTab管理后台：',
  'settings.openAdminTabAfterWindowCreated.yes': '自动打开NiceTab管理后台',
  'settings.openAdminTabAfterWindowCreated.no': '不自动打开NiceTab管理后台',
  ...
  'settings.newTabDisplay': '新标签页显示方式：',
  'settings.newTabDisplay.tooltip': '该配置项可以定制化新标签页，选择“默认”选项可恢复为浏览器官方默认新标签页。',
  'settings.newTabDisplay.homePage': 'NiceTab 列表页',
  'settings.newTabDisplay.niceNewtab': 'NiceTab 新标签页',
  'settings.newTabDisplay.default': '默认（恢复为浏览器默认新标签页）',
  ...
  'settings.autoSyncTimeRanges': '自动同步开启时段：',
  'settings.autoSyncTimeRanges.addRange': '添加时段',
