...
const zhTW: Record<LocaleKey, string> = {
  ...
  'home.help.content': `
    ...
    <li>“還原”操作表示將資源回收桶中的分頁群組還原到首頁列表中。</li>
    <li>“遞增”和“遞減”功能只對目前分類中的非加星號的分頁群組進行排序。</li>
    <li><strong>注意</strong>：為了保證互動效能，目前分類中分頁數量超過設定值時，右側面板將開啟虛擬滾動，根據滾動位置顯示部分分頁群組。</li>
    <li>分類/分頁群組/分頁支援拖曳排序，當分類/分頁群組處在選取狀態時，可透過快捷鍵進行排序，快捷鍵對應見下表：</li>
  `,
