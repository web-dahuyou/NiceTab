export default {
  ...
  'sync.tip.autoPullMerge': 'Automatically pull remote data and merge it into local data.',
  'sync.tip.autoPullForce': 'Automatically pull remote data and force to overwrite local data.',
  'sync.tip.autoPushMerge': 'Automatically pull remote data, merge it into local data, and then push to remote.',
  'sync.tip.autoPushForce': 'Automatically push local data to remote (force to overwrite).',
  'sync.tip.manualPullMerge': 'Pull remote data, merge to local data.',
