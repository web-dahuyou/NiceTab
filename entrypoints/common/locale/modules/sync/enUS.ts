export default {
  ...
  'sync.tip.autoPullMerge': 'Automatically Pull remote data, merge to local data.',
  'sync.tip.autoPullForce': 'Automatically Pull remote data, force overwrite local data.',
  'sync.tip.autoPushMerge': 'Automatically Pull remote data, merge to local data, and then push to remote.',
  'sync.tip.autoPushForce': 'Automatically Push local data to remote (force overwrite).',
